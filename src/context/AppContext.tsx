  ...
  return {
    ...
    profiles: {
      Personal: {
        ...
        incomes: [
          { id: 'inc_sample_1', name: 'Sueldo Principal', amount: 350, freq: 'biweekly', day: '15-30' },
        ],
        expenses: [
          { id: 'exp_sample_1', name: 'Alquiler / Servicios', amount: 120, freq: 'monthly', day: 5, flex: false },
        ],
        debts: [
          {
            id: 'debt_sample_1',
        ...
        p2p: [],
        overrides: {},
        savings: { current: 50, digital: 100 },
      },
    },
    authToken: null,
    authUser: null,
