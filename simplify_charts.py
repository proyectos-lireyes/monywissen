...
# We want to replace everything from `<ResponsiveContainer width="100%" height="100%">`
# up to `</ResponsiveContainer>` with our simplified version.

pattern = re.compile(r'<ResponsiveContainer width="100%" height="100%">.*?</ResponsiveContainer>', re.DOTALL)

replacement = """<ResponsiveContainer width="100%" height="100%">
              {(() => {
